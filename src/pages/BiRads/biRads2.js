...
const BiRads2 = () => {
  ...
  return (
    ...
    <>
      ...
      />
      <div onClick={()=>{gV.biRads = 2;}}   className='bi-rads__footer'>
      ...
      <div className='bi-rads'>
        ...
        <div className='bi-rads__header'>
          ...
          <p style={{fontSize:"32px", width:"100%", fontFamily:"Avenir-Roman"}} className='normal-text bi-rads__header__text'>Got a Birads-2 assessment on your breast screening?</p>
        ...
        <div className='bi-rads__main'>
         ...
         <div style={{width:"100%"}} className='bi-rads__main normal-text'>
           ...
           <p>If you receive a Bi-rads 2 score this means that the result on your mammogram/ultrasound is negative (meaning there is no sign of cancer), but the radiologist has identified other benign findings in the breast such as benign calcifications, masses, or lymph nodes.</p>
       ...
       <a onClick={()=>{gV.biRads = "2"; gV.p = 0}}  style={{width:"230px",height:"47px"}} className="button" 
